...
from diagnosis.failure_event import FailureCluster, FailureEvent
...
from diagnosis.taxonomy import ContextDeficiencyType
...
def _no_patch() -> PatchSignals:
    ...
    from diagnosis.signals.schema import PatchSignals
