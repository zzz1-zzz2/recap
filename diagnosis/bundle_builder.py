...
from diagnosis.signals.frame_normalizer import normalize_frame
from diagnosis.signals.schema import (
...
def build_failure_feature_bundle(
    ...
    if patch_text.strip():
        from diagnosis.signals.patch_extractor import extract_patch_signals
        bundle.patch = extract_patch_signals(patch_text)

    # Trajectory signals
    if trajectory:
        from diagnosis.signals.trajectory_extractor import extract_trajectory_signals
