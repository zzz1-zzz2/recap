...
from recap.continuation.prompt_builder import build_branch_messages
from recap.continuation.agent_config import redact_trajectory
...
def run_branch(
    *,
    ...
    try:
        ...
        from recap.patch_artifacts import (
